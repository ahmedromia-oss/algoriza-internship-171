...
namespace Repository.Migrations
{
    ...
    [Migration("20231209123617_AddingRequestsTable")]
    partial class AddingRequestsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Request", b =>
                {
                    ...
                    b.Property<int>("RequestsCancelled")
                        .HasColumnType("int");

                    b.Property<int>("RequestsCompleted")
                        .HasColumnType("int");

                    b.Property<int>("RequestsPending")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "09c13eaa-11eb-47d2-bd17-993d6907033b",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAENrhtAeFBBARZmG1MEKlbidbwfc6rS0ZoHIwSIdREMtMZOUyx+VsBntmu8NUNOxI9w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6e113ac6-683a-4fa8-990b-5ea6258c3d45",
            ...
            modelBuilder.Entity("Core.Domain.Request", b =>
                {
                    b.HasOne("Core.Domain.Doctor", "Doctor")
                        .WithOne()
                        .HasForeignKey("Core.Domain.Request", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
